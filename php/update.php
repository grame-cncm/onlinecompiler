...
function update()
{
  ...
  exec("touch /home/faust/www/compiler/tmp/".$_SESSION['id']."/history.txt", $none, $ret);
  ...
  if ($_SESSION['fileDroped'] == 1){
    $dropedFilePath = "/home/faust/www/compiler/tmp/".$_SESSION['id']."/uploads/".$_SESSION['dropedFileName'];
